...
function LogInVendedor() {
  ...
  const handleLogin = async (e) => {
    e.preventDefault();
    try {
      await loginVendedor(email, password);
      navigate("/vendedor");
    } catch (error) {}
  };
      ...
      >
        <div className="row g-5">
          ...
          >
            ...
            />
            <h3 className="fw-bold text-center">Panel de Vendedor</h3>
            <p className="text-center text-light mt-2">
              Gestiona tus ventas y clientes de manera rápida.
            </p>
          </div>
              ...
              <form onSubmit={handleLogin}>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    placeholder="vendedor@pasteleria.com"
                    value={email}
